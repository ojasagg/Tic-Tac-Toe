...
def compute_values(tree,value,key,turn):
	...
	if turn==1:
		chldrn=[]
		for i in tree[key][0]:
			chldrn.append(compute_values(tree,value,i,1-turn))
...
compute_values(tree,value,s,1)
#Tree with value stored upto now

print "Time taken via minimax is "+str(time.time()-start_time)+"sec"
